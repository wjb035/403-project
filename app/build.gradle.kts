...
android {
    namespace = "com.basketball.logintestapplication"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.basketball.logintestapplication"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.appcompat)                                  // add app compatibility layer
}